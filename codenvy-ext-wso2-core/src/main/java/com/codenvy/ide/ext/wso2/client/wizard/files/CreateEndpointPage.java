...
public class CreateEndpointPage extends AbstractCreateResourcePage {
    ...
    public static final String ENDPOINTS_FOLDER_NAME = "endpoints";
    ...
    public String getNotice() {
        ...
        if (incorrectName) {
            return locale.wizardFileEndpointNoticeIncorrectName();
        }

        if (hasSameFile) {
            return locale.wizardFileEndpointNoticeFileExists();
        }
