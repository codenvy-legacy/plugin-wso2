...
import static com.codenvy.ide.client.elements.mediators.Respond.ELEMENT_NAME;
import static com.codenvy.ide.client.elements.mediators.Respond.SERIALIZATION_NAME;
 ...
 */
public class RespondTest extends AbstractElementTest<Respond> {

    private static final String PATH_TO_EXAMPLES = "mediators/respond/serialize/";
    ...
    @Before
    public void setUp() {
        when(resources.respond()).thenReturn(icon);

        entity = new Respond(resources, branchProvider, elementCreatorsManager);
    }
