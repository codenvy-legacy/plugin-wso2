 ...
 */
package com.codenvy.ide.client.propertiespanel.connectors.salesforce.queryall;
 ...
 */
public class QueryAllPropertiesPanelPresenter extends GeneralConnectorPanelPresenter<QueryAll> {
    ...
    @Inject
    public QueryAllPropertiesPanelPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.batchSizeNameSpacesCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                QueryAllPropertiesPanelPresenter.this.view.setSecondTextBoxValue(expression);
        ...
        this.queryStringNameSpacesCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                QueryAllPropertiesPanelPresenter.this.view.setFirstTextBoxValue(expression);
