 ...
 */
public class GetCellRange extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetCellRange";
    public static final String SERIALIZATION_NAME = "googlespreadsheet.getCellRange";
