...
/**
 * The Class describes UpdateIssueAssignee connector for jira group connectors. Also the class contains the business logic
 ...
 */
public class UpdateIssueAssignee extends AbstractConnector {

    public static final String ELEMENT_NAME       = "UpdateIssueAssignee";
    public static final String SERIALIZATION_NAME = "jira.updateIssueAssignee";
    ...
    @Inject
    public UpdateIssueAssignee(EditorResources resources,
