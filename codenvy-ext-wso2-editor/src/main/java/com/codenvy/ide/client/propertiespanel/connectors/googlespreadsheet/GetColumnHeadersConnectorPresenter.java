    ...
    public GetColumnHeadersConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.spreadsheetNameCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetColumnHeadersConnectorPresenter.this.view.setFirstTextBoxValue(expression);
        ...
        this.worksheetNameCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetColumnHeadersConnectorPresenter.this.view.setSecondTextBoxValue(expression);
