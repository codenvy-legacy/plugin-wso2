...
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.GetColumnHeaders.SPREADSHEET_NAME_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.GetColumnHeaders.SPREADSHEET_NAME_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.GetColumnHeaders.SPREADSHEET_NAME_NS_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.GetColumnHeaders.WORKSHEET_NAME_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.GetColumnHeaders.WORKSHEET_NAME_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.GetColumnHeaders.WORKSHEET_NAME_NS_KEY;
 ...
 */
public class GetColumnHeadersConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetColumnHeaders> {
    ...
    @Inject
    public GetColumnHeadersConnectorPresenter(WSO2EditorLocalizationConstant locale,
