...
import static com.codenvy.ide.client.elements.connectors.jira.GetVotesForIssue.ISSUE_ID_OR_KEY_EXPR;
import static com.codenvy.ide.client.elements.connectors.jira.GetVotesForIssue.ISSUE_ID_OR_KEY_INL;
import static com.codenvy.ide.client.elements.connectors.jira.GetVotesForIssue.ISSUE_ID_OR_KEY_NS;
 ...
 */
public class GetVotesForIssueConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetVotesForIssue> {

    private SimplePropertyPresenter issueIdOrKeyInl;
    private ComplexPropertyPresenter issueIdOrKeyExpr;

    @Inject
    public GetVotesForIssueConnectorPresenter(WSO2EditorLocalizationConstant locale,
