...
public class SearchCellConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<SearchCell> {
    ...
    private void prepareView() {
        ...
        searchStringNS = createComplexConnectorProperty(locale.spreadsheetSearchCellSearchString(),
        ...
        searchString = createSimpleConnectorProperty(locale.spreadsheetSearchCellSearchString(), SEARCH_STRING_KEY);
    }
