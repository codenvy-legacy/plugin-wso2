...
/**
 * The Class contains state of available configuration parameter, which is general for all Google spreadsheet connectors.
 *
 * @author Valeriy Svydenko
 */
@Singleton
public class GoogleSpreadsheetPropertyManager implements ConnectorPropertyManager {

    private final List<String>                    availableConfigs;
    private final List<ConnectorPropertyListener> listeners;

    @Inject
    public GoogleSpreadsheetPropertyManager() {
