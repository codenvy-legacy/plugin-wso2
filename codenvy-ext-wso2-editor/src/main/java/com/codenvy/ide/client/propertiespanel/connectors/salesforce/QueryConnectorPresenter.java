...
import static com.codenvy.ide.client.elements.connectors.salesforce.Query.BATCH_SIZE_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Query.BATCH_SIZE_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Query.BATCH_SIZE_NS_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Query.QUERY_STRING_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Query.QUERY_STRING_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Query.QUERY_STRING_NS_KEY;
 ...
 */
public class QueryConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<Query> {
    ...
    @Inject
    public QueryConnectorPresenter(WSO2EditorLocalizationConstant locale,
    ...
    private void prepareView() {
        ...
        queryStringNS = createComplexConnectorProperty(locale.connectorQueryString(), QUERY_STRING_NS_KEY, QUERY_STRING_EXPRESSION_KEY);

        batchSize = createSimpleConnectorProperty(locale.connectorBatchSize(), BATCH_SIZE_KEY);
        queryString = createSimpleConnectorProperty(locale.connectorQueryString(), QUERY_STRING_KEY);
    }
