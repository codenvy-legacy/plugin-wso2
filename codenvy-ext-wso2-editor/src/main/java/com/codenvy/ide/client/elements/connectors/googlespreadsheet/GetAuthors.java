...
/**
 * The Class describes GetAuthors connector for GoogleSpreadsheet group connectors. Also the class contains the business logic
 * that allows to display serialization representation depending of the current state of element. Deserelization mechanism allows to
 * restore the condition of the element when you open ESB project after saving.
 *
 * @author Valeriy Svydenko
 */
public class GetAuthors extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetAuthors";
    public static final String SERIALIZATION_NAME = "googlespreadsheet.getAuthors";
    ...
    @Inject
    public GetAuthors(EditorResources resources,
