...
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.ACCESS_TOKEN_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.ACCESS_TOKEN_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.ACCESS_TOKEN_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.ACCESS_TOKEN_SECRET_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.ACCESS_TOKEN_SECRET_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.ACCESS_TOKEN_SECRET_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.CONSUMER_KEY_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.CONSUMER_KEY_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.CONSUMER_KEY_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.CONSUMER_SECRET_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.CONSUMER_SECRET_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.CONSUMER_SECRET_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.COUNT_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.COUNT_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.COUNT_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.MAX_ID_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.MAX_ID_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.MAX_ID_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.PAGE_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.PAGE_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.PAGE_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.SINCE_ID_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.SINCE_ID_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetDirectMessages.SINCE_ID_NS;
