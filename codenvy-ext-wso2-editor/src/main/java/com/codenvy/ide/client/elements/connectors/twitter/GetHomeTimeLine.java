 ...
 */
public class GetHomeTimeLine extends AbstractConnector {
    ...
    @Inject
    public GetHomeTimeLine(EditorResources resources, Provider<Branch> branchProvider, MediatorCreatorsManager mediatorCreatorsManager) {
