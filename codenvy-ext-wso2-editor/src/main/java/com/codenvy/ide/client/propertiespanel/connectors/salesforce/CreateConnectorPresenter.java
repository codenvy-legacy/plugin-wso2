...
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.ALL_OR_NONE_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.ALL_OR_NONE_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.ALL_OR_NONE_NS_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.SUBJECTS_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.SUBJECTS_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.SUBJECTS_NS_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.TRUNCATE_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.TRUNCATE_KEY;
import static com.codenvy.ide.client.elements.connectors.salesforce.Create.TRUNCATE_NS_KEY;
...
public class CreateConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<Create> {
    ...
    private void prepareView() {
        ...
        truncateNS = createComplexConnectorProperty(locale.connectorAllowFieldTruncate(), TRUNCATE_NS_KEY, TRUNCATE_EXPRESSION_KEY);
        ...
        truncate = createSimpleConnectorProperty(locale.connectorAllowFieldTruncate(), TRUNCATE_KEY);
    ...
    public void go(@Nonnull AcceptsOneWidget container) {
        ...
        truncate.setProperty(element.getProperty(TRUNCATE_KEY));
        ...
        truncateNS.setProperty(element.getProperty(TRUNCATE_EXPRESSION_KEY));
