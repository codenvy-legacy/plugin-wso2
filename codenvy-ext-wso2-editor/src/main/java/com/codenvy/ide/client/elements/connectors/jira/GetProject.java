 ...
 */
public class GetProject extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetProject";
    public static final String SERIALIZATION_NAME = "jira.getProject";
    ...
    @Inject
    public GetProject(EditorResources resources,
