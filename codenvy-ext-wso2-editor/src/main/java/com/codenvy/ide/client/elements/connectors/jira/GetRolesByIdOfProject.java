 ...
 */
public class GetRolesByIdOfProject extends AbstractConnector {
    ...
    private Array<NameSpace> roleIdNS;
    ...
    @Nonnull
    public Array<NameSpace> getRoleIdNS() {
        return roleIdNS;
    }

    public void setRoleIdNS(@Nonnull Array<NameSpace> roleIdNS) {
