...
/**
 * The class provides the business logic that allows editor to react on user's action related to change of Log's
 ...
 */
public class AddPropertyLogPresenter extends AddPropertyPresenter<Property> {
    ...
    @Inject
    public AddPropertyLogPresenter(AddPropertyView view,
        ...
        this.nameSpacesCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull List<NameSpace> nameSpaces, @Nonnull String valueExpression) {
                ...
                selectedProperty.putProperty(Property.EXPRESSION, valueExpression);
    ...
    public void showDialog(@Nullable Property property, @Nonnull AddPropertyCallBack<Property> callBack) {
        ...
        boolean isVisible = EXPRESSION.equals(propertyType);
        ...
        view.setTitle(local.propertyLogEditTableTitle());
