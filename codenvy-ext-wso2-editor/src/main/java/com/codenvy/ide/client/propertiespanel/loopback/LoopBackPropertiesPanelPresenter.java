...
/**
 * The presenter that provides a business logic of 'LoopBack' mediator properties panel. It provides an ability to work with all properties
 * of 'LoopBack' mediator.
 *
