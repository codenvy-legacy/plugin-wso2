...
/**
 * Provides a graphical representation of DescribeSobject connector property panel for editing property of Create connector.
 *
 * @author Valeriy Svydenko
 */
public class DescribeSubjectPropertiesPanelViewImpl extends DescribeSubjectPropertiesPanelView {

    @Singleton
    interface DescribeSobjectPropertiesPanelViewImplUiBinder extends UiBinder<Widget, DescribeSubjectPropertiesPanelViewImpl> {
    }
    ...
    @Inject
    public DescribeSubjectPropertiesPanelViewImpl(DescribeSobjectPropertiesPanelViewImplUiBinder ourUiBinder,
                                                  EditorResources res,
