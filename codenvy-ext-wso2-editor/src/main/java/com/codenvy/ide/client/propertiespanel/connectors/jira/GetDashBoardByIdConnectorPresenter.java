...
import static com.codenvy.ide.client.elements.connectors.jira.GetDashboardById.ID_EXPR;
import static com.codenvy.ide.client.elements.connectors.jira.GetDashboardById.ID_INL;
import static com.codenvy.ide.client.elements.connectors.jira.GetDashboardById.ID_NS;
 ...
 */
public class GetDashBoardByIdConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetDashboardById> {

    private SimplePropertyPresenter  idInl;
    private ComplexPropertyPresenter idExpr;

    @Inject
    public GetDashBoardByIdConnectorPresenter(WSO2EditorLocalizationConstant locale,
    ...
    private void prepareView() {
        idInl = createSimpleConnectorProperty(locale.jiraId(), ID_INL);
