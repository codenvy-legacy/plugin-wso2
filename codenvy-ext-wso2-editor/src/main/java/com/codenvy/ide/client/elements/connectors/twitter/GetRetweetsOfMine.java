 ...
 */
public class GetRetweetsOfMine extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetRetweetsOfMine";
    public static final String SERIALIZATION_NAME = "twitter.getRetweetsOfMine";
