 ...
 */
public class GetFollowers extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetFollowers";
    public static final String SERIALIZATION_NAME = "twitter.getFollowers";
    ...
    @Inject
    public GetFollowers(EditorResources resources, Provider<Branch> branchProvider, MediatorCreatorsManager mediatorCreatorsManager) {
