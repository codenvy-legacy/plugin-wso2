    ...
    public GetSentDirectMessagesConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.consumerKeyCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setFirstTextBoxValue(expression);
        ...
        this.consumerSecretCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setSecondTextBoxValue(expression);
        ...
        this.accessTokenCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setThirdTextBoxValue(expression);
        ...
        this.accessTokenSecretCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setFourthTextBoxValue(expression);
        ...
        this.countCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setFifthTextBoxValue(expression);
        ...
        this.pageCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setSixthTextBoxValue(expression);
        ...
        this.sinceIdCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setSeventhTextBoxValue(expression);
        ...
        this.maxIdCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetSentDirectMessagesConnectorPresenter.this.view.setEighthTextBoxValue(expression);
