 ...
 */
public class GetComponentsOfProject extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetComponentsOfProject";
    public static final String SERIALIZATION_NAME = "jira.getComponentsOfProject";
