...
/**
 * The Class describes GetFriends connector for twitter group of connectors. Also the class contains the business logic
 * that allows to display serialization representation depending of the current state of element. Deserelization mechanism allows to
 * restore the condition of the element when you open ESB project after saving.
 *
 * @author Dmitry Shnurenko
 */
public class GetFriends extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetFriends";
    public static final String SERIALIZATION_NAME = "twitter.getFriends";
    ...
    @Inject
    public GetFriends(EditorResources resources, Provider<Branch> branchProvider, MediatorCreatorsManager mediatorCreatorsManager) {
