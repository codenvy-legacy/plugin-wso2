...
public class CreateSpreadsheetConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<CreateSpreadsheet> {
    ...
    public CreateSpreadsheetConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.spreadsheetNameCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                CreateSpreadsheetConnectorPresenter.this.view.setFirstTextBoxValue(expression);
        ...
        this.worksheetNameCallBack = new AddNameSpacesCallBack() {
            @Override
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                element.setWorksheetCountNS(nameSpaces);
                element.setWorksheetCountExpression(expression);

                CreateSpreadsheetConnectorPresenter.this.view.setSecondTextBoxValue(expression);
    ...
    public void onSecondTextBoxValueChanged() {
        element.setWorksheetCount(view.getSecondTextBoxValue());
    ...
    public void onSecondButtonClicked() {
        nameSpacePresenter.showWindowWithParameters(element.getWorksheetCountNS(),
                                                    ...
                                                    locale.connectorExpression(),
                                                    element.getWorksheetCountExpression());
    }
    ...
    private void redesignViewToCurrentConnector() {
        ...
        view.setSecondLabelTitle(locale.spreadsheetCreateSpreadsheetWorksheetCount());
    }
    ...
    protected void redrawPropertiesPanel() {
        ...
        view.setSecondTextBoxValue(isEquals ? element.getWorksheetCountExpression() : element.getWorksheetCount());
    }
