...
public class AddAttachmentConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<AddAttachmentToIssueId> {
    ...
    private final AddNameSpacesCallBack          addAttachmentNameSpacesCallBack;
    ...
    public AddAttachmentConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.addAttachmentNameSpacesCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                AddAttachmentConnectorPresenter.this.view.setFirstTextBoxValue(expression);
    ...
    public void onFirstButtonClicked() {
        nameSpacePresenter.showWindowWithParameters(element.getIssueIdOrKeyNameSpaces(),
                                                    addAttachmentNameSpacesCallBack,
