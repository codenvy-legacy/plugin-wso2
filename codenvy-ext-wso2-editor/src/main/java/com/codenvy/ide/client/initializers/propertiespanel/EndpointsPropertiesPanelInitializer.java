...
public class EndpointsPropertiesPanelInitializer implements Initializer {
    ...
    @Inject
    public EndpointsPropertiesPanelInitializer(PropertiesPanelManager propertiesPanelManager,
    ...
    public void initialize() {
        propertiesPanelManager.register(AddressEndpoint.class, addressEndpointPropertiesPanel);
    }
