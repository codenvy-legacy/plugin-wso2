...
public class GetIssueTypeByIdConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetIssueTypeById> {
    ...
    private final AddNameSpacesCallBack          issueTypeIdCallBack;
    ...
    public GetIssueTypeByIdConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.issueTypeIdCallBack = new AddNameSpacesCallBack() {
            @Override
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                element.setIssueTypeIdNS(nameSpaces);
                element.setIssueTypeIdExpression(expression);

                GetIssueTypeByIdConnectorPresenter.this.view.setFirstTextBoxValue(expression);
    ...
    public void onFirstTextBoxValueChanged() {
        element.setIssueTypeId(view.getFirstTextBoxValue());
    ...
    public void onFirstButtonClicked() {
        nameSpacePresenter.showWindowWithParameters(element.getIssueTypeIdNS(),
                                                    issueTypeIdCallBack,
    ...
    private void redesignViewToCurrentConnector() {
        ...
        view.setFirstLabelTitle(locale.jiraIssueTypeId());
    }
