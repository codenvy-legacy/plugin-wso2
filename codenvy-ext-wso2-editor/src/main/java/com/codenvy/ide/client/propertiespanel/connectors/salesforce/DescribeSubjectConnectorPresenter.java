...
public class DescribeSubjectConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<DescribeSubject> {
    ...
    private void prepareView() {
        subjectNS = createComplexConnectorProperty(locale.propertiespanelConnectorSubject(), SUBJECT_NS_KEY, SUBJECT_EXPRESSION_KEY);
        subject = createSimpleConnectorProperty(locale.propertiespanelConnectorSubject(), SUBJECT_KEY);
    }
