...
/**
 * The Class describes UpdateComment connector for jira group connectors. Also the class contains the business logic
 ...
 */
public class UpdateComment extends AbstractConnector {

    public static final String ELEMENT_NAME       = "UpdateComment";
    public static final String SERIALIZATION_NAME = "jira.updateComment";
    ...
    @Inject
    public UpdateComment(EditorResources resources,
