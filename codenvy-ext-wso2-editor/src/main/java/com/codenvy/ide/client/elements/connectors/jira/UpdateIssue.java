...
/**
 * The Class describes UpdateIssue connector for jira group connectors. Also the class contains the business logic
 * that allows to display serialization representation depending of the current state of element. Deserelization mechanism allows to
 * restore the condition of the element when you open ESB project after saving.
 *
 * @author Dmitry Shnurenko
 */
public class UpdateIssue extends AbstractConnector {

    public static final String ELEMENT_NAME       = "UpdateIssue";
    public static final String SERIALIZATION_NAME = "jira.updateIssue";
    ...
    @Inject
    public UpdateIssue(EditorResources resources, Provider<Branch> branchProvider, MediatorCreatorsManager mediatorCreatorsManager) {
