...
/**
 * The Class contains state of available configuration parameter, which is general for all twitter connectors.
 *
 * @author Dmitry Shnurenko
 */
@Singleton
public class TwitterPropertyManager implements ConnectorPropertyManager {

    private final List<String>                    availableConfigs;
    private final List<ConnectorPropertyListener> listeners;

    @Inject
    public TwitterPropertyManager() {
