...
/**
 * The Class describes DeleteWorksheet connector for GoogleSpreadsheet group connectors. Also the class contains the business logic
 * that allows to display serialization representation depending of the current state of element. Deserelization mechanism allows to
 * restore the condition of the element when you open ESB project after saving.
 *
 * @author Valeriy Svydenko
 */
public class DeleteWorksheet extends AbstractConnector {

    public static final String ELEMENT_NAME       = "DeleteWorksheet";
    public static final String SERIALIZATION_NAME = "googlespreadsheet.deleteWorksheet";
    ...
    @Inject
    public DeleteWorksheet(EditorResources resources,
