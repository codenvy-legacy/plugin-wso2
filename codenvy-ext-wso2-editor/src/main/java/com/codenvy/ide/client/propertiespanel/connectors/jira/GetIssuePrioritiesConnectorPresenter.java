 ...
 */
public class GetIssuePrioritiesConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetIssuePriorities> {

    @Inject
    public GetIssuePrioritiesConnectorPresenter(WSO2EditorLocalizationConstant locale,
