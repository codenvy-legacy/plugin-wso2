...
import static com.codenvy.ide.client.elements.connectors.jira.GetTransitions.ISSUE_ID_OR_KEY_EXPR;
import static com.codenvy.ide.client.elements.connectors.jira.GetTransitions.ISSUE_ID_OR_KEY_INL;
import static com.codenvy.ide.client.elements.connectors.jira.GetTransitions.ISSUE_ID_OR_KEY_NS;
 ...
 */
public class GetTransitionsConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetTransitions> {

    private SimplePropertyPresenter  issueIdOrKeyInl;
    private ComplexPropertyPresenter issueIdOrKeyExpr;

    @Inject
    public GetTransitionsConnectorPresenter(WSO2EditorLocalizationConstant locale,
