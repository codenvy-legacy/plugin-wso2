 ...
 */
public class ShowStatus extends AbstractConnector {
    ...
    @Inject
    public ShowStatus(EditorResources resources, Provider<Branch> branchProvider, MediatorCreatorsManager mediatorCreatorsManager) {
        super(ELEMENT_NAME,
              ELEMENT_NAME,
              SERIALIZATION_NAME,
              PROPERTIES,
