...
import static com.codenvy.ide.client.elements.connectors.jira.UpdateIssueAssignee.ISSUE_ID_OR_KEY_EXPR;
import static com.codenvy.ide.client.elements.connectors.jira.UpdateIssueAssignee.ISSUE_ID_OR_KEY_INL;
import static com.codenvy.ide.client.elements.connectors.jira.UpdateIssueAssignee.ISSUE_ID_OR_KEY_NS;
 ...
 */
public class UpdateIssueAssigneeConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<UpdateIssueAssignee> {

    private SimplePropertyPresenter  issueIdOrKeyInl;
    private ComplexPropertyPresenter issueIdOrKeyExpr;

    @Inject
    public UpdateIssueAssigneeConnectorPresenter(WSO2EditorLocalizationConstant locale,
