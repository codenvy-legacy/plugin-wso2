    ...
    public SetActorsToRoleOfProjectConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.projectKeyCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                SetActorsToRoleOfProjectConnectorPresenter.this.view.setFirstTextBoxValue(expression);
        ...
        this.roleIdCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                SetActorsToRoleOfProjectConnectorPresenter.this.view.setSecondTextBoxValue(expression);
