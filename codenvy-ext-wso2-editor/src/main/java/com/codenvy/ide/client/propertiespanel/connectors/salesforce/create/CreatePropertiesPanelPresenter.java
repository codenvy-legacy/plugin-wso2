 ...
 */
public class CreatePropertiesPanelPresenter extends GeneralConnectorPanelPresenter<Create> {
    ...
    @Inject
    public CreatePropertiesPanelPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.allOrNoneCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                CreatePropertiesPanelPresenter.this.view.setFirstTextBoxValue(expression);
        ...
        this.truncateCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                CreatePropertiesPanelPresenter.this.view.setSecondTextBoxValue(expression);
        ...
        this.sobjectsCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                CreatePropertiesPanelPresenter.this.view.setThirdTextBoxValue(expression);
