...
/**
 * The Class describes GetVersionsOfProject connector for jira group connectors. Also the class contains the business logic
 ...
 */
public class GetVersionsOfProject extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetVersionsOfProject";
    public static final String SERIALIZATION_NAME = "jira.getVersionsOfProject";
    ...
    @Inject
    public GetVersionsOfProject(EditorResources resources,
