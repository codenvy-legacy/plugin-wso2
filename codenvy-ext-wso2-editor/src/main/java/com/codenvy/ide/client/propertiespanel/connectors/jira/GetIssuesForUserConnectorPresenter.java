 ...
 */
public class GetIssuesForUserConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetIssuesForUser> {

    @Inject
    public GetIssuesForUserConnectorPresenter(WSO2EditorLocalizationConstant locale,
