...
/**
 * The Class describes GetTransitions connector for jira group connectors. Also the class contains the business logic
 ...
 */
public class GetTransitions extends AbstractConnector {

    public static final String ELEMENT_NAME       = "GetTransitions";
    public static final String SERIALIZATION_NAME = "jira.getTransitions";
    ...
    @Inject
    public GetTransitions(EditorResources resources, Provider<Branch> branchProvider, MediatorCreatorsManager mediatorCreatorsManager) {
        super(ELEMENT_NAME,
              ELEMENT_NAME,
              SERIALIZATION_NAME,
              PROPERTIES,
