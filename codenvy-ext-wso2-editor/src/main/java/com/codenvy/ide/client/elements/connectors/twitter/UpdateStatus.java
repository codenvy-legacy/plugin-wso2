...
public class UpdateStatus extends AbstractConnector {
    ...
    @Inject
    public UpdateStatus(EditorResources resources, Provider<Branch> branchProvider, MediatorCreatorsManager mediatorCreatorsManager) {
    ...
    protected String serializeProperties() {
        ...
        properties.put(STATUS, isInline ? statusId : statusIdExpr);
