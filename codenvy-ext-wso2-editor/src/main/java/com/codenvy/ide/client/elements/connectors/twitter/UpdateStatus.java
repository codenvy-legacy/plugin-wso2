 ...
 */
public class UpdateStatus extends AbstractConnector {

    public static final String ELEMENT_NAME       = "UpdateStatus";
    public static final String SERIALIZATION_NAME = "twitter.updateStatus";
    ...
    public static final Key<String> STATUS_INL              = new Key<>("idInl");
    ...
    public static final Key<String> STATUS_EXPR              = new Key<>("statusExpr");
    ...
    public static final Key<List<NameSpace>> STATUS_NS              = new Key<>("statusNameSpace");
    ...
    @Inject
    public UpdateStatus(EditorResources resources, Provider<Branch> branchProvider, ElementCreatorsManager elementCreatorsManager) {
        super(ELEMENT_NAME,
              ELEMENT_NAME,
              SERIALIZATION_NAME,
              PROPERTIES,
        ...
        putProperty(STATUS_NS, new ArrayList<NameSpace>());
    }
    ...
    protected String serializeProperties() {
        ...
        properties.put(STATUS, isInline ? getProperty(STATUS_INL) : getProperty(STATUS_EXPR));
