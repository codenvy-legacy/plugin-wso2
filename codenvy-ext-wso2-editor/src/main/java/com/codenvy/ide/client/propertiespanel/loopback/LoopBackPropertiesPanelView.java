...
public abstract class LoopBackPropertiesPanelView extends AbstractView<LoopBackPropertiesPanelView.ActionDelegate> {
    ...
    /**
     * Interface defines methods of {@link LoopBackPropertiesPanelPresenter} which calls from view. These methods defines
     * some actions when user changes properties of LoopBack mediator.
     */
