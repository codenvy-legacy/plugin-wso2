...
/**
 * The presenter that provides a business logic of 'Payload Factory' mediator properties panel. It provides an ability to work with all
 * properties of 'Payload Factory' mediator.
 *
