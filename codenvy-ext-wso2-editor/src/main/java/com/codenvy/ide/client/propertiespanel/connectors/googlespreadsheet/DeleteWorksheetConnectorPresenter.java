...
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.DeleteWorksheet.SPREADSHEET_NAME_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.DeleteWorksheet.SPREADSHEET_NAME_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.DeleteWorksheet.SPREADSHEET_NAME_NS_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.DeleteWorksheet.WORKSHEET_NAME_EXPRESSION_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.DeleteWorksheet.WORKSHEET_NAME_KEY;
import static com.codenvy.ide.client.elements.connectors.googlespreadsheet.DeleteWorksheet.WORKSHEET_NAME_NS_KEY;
...
public class DeleteWorksheetConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<DeleteWorksheet> {
    ...
    @Inject
    public DeleteWorksheetConnectorPresenter(WSO2EditorLocalizationConstant locale,
