    ...
    public DeleteWorksheetConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.spreadsheetNameCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                DeleteWorksheetConnectorPresenter.this.view.setSecondTextBoxValue(expression);
        ...
        this.worksheetNameCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                DeleteWorksheetConnectorPresenter.this.view.setFirstTextBoxValue(expression);
