    ...
    public GetFollowersIdsConnectorPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.screenNameCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetFollowersIdsConnectorPresenter.this.view.setFirstTextBoxValue(expression);
        ...
        this.userIdCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetFollowersIdsConnectorPresenter.this.view.setSecondTextBoxValue(expression);
        ...
        this.cursorCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                GetFollowersIdsConnectorPresenter.this.view.setThirdTextBoxValue(expression);
