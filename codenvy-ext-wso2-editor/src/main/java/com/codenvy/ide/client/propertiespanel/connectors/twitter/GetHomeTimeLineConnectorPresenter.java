...
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.ACCESS_TOKEN_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.ACCESS_TOKEN_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.ACCESS_TOKEN_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.ACCESS_TOKEN_SECRET_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.ACCESS_TOKEN_SECRET_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.ACCESS_TOKEN_SECRET_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.CONSUMER_KEY_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.CONSUMER_KEY_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.CONSUMER_KEY_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.CONSUMER_SECRET_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.CONSUMER_SECRET_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.CONSUMER_SECRET_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.COUNT_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.COUNT_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.COUNT_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.MAX_ID_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.MAX_ID_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.MAX_ID_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.PAGE_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.PAGE_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.PAGE_NS;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.SINCE_ID_EXPR;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.SINCE_ID_INL;
import static com.codenvy.ide.client.elements.connectors.twitter.GetHomeTimeLine.SINCE_ID_NS;
