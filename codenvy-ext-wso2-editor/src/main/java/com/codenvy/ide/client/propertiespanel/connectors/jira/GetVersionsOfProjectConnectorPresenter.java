...
import static com.codenvy.ide.client.elements.connectors.jira.GetVersionsOfProject.PROJECT_KEY_EXPR;
import static com.codenvy.ide.client.elements.connectors.jira.GetVersionsOfProject.PROJECT_KEY_INL;
import static com.codenvy.ide.client.elements.connectors.jira.GetVersionsOfProject.PROJECT_KEY_NS;
 ...
 */
public class GetVersionsOfProjectConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetVersionsOfProject> {

    private SimplePropertyPresenter  projectKeyInl;
    private ComplexPropertyPresenter projectKeyExpr;

    @Inject
    public GetVersionsOfProjectConnectorPresenter(WSO2EditorLocalizationConstant locale,
