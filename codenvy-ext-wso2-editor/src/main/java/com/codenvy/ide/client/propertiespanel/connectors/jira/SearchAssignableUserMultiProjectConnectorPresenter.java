...
public class SearchAssignableUserMultiProjectConnectorPresenter
    ...
    private void prepareView() {
        ...
        projectKeysInl = createSimpleConnectorProperty(locale.jiraProjectKeys(), PROJECT_KEYS_INL);
        ...
        projectKeysExpr = createComplexConnectorProperty(locale.jiraProjectKeys(), PROJECT_KEYS_NS, PROJECT_KEYS_EXPR);
