...
import static com.codenvy.ide.client.elements.connectors.jira.GetIssue.ISSUE_ID_OR_KEY_EXPR;
import static com.codenvy.ide.client.elements.connectors.jira.GetIssue.ISSUE_ID_OR_KEY_INL;
import static com.codenvy.ide.client.elements.connectors.jira.GetIssue.ISSUE_ID_OR_KEY_NS;
 ...
 */
public class GetIssueConnectorPresenter extends AbstractConnectorPropertiesPanelPresenter<GetIssue> {

    private SimplePropertyPresenter  issueIdOrKeyInl;
    private ComplexPropertyPresenter issueIdOrKeyExpr;

    @Inject
    public GetIssueConnectorPresenter(WSO2EditorLocalizationConstant locale,
