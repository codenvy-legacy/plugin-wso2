 ...
 */
package com.codenvy.ide.client.propertiespanel.connectors.salesforce.querymore;
 ...
 */
public class QueryMorePropertiesPanelPresenter extends GeneralConnectorPanelPresenter<QueryMore> {
    ...
    @Inject
    public QueryMorePropertiesPanelPresenter(WSO2EditorLocalizationConstant locale,
        ...
        this.batchSizeNameSpacesCallBack = new AddNameSpacesCallBack() {
            ...
            public void onNameSpacesChanged(@Nonnull Array<NameSpace> nameSpaces, @Nonnull String expression) {
                ...
                QueryMorePropertiesPanelPresenter.this.view.setSecondTextBoxValue(expression);
